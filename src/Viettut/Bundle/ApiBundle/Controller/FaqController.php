 ...
 * @RouteResource("Faq")
 */
class FaqController extends RestControllerAbstract implements ClassResourceInterface
{
     ...
     *
     * @Rest\View(
     *      serializerGroups={"faq.summary", "user.summary"}
     * )
     *
     * @ApiDoc(
     *  resource = true,
    ...
    {
        return $this->container->get('viettut_api.handler.faq');
    }
}