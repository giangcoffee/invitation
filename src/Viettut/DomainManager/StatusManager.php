...
class StatusManager implements StatusManagerInterface
{
    ...
    public function __construct(EntityManagerInterface $em, StatusRepositoryInterface $repository)
    {
        $this->em = $em;
    ...
    {
        return is_subclass_of($entity, StatusInterface::class);
    }
    ...
    public function save(ModelInterface $entity)
    {
        if (!$entity instanceof StatusInterface) {
            throw new InvalidArgumentException('expect an StatusInterface object');
        }
